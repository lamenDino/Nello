#!/usr/bin/env python3
"""
Social Media Downloader v4.4
- VIDEO + CAROSELLO FOTO (Instagram: supporto thumbnails)
- Retry 2 tentativi (poi stop)
- Fallback TikTok: se yt-dlp dà errori tipici ("status code 0"), prova TikTokDownloader
"""
    ...
    async def download_video(self, url: str) -> Dict:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if not info:
                    # TikTok fallback se sembra blocco
                ...
                # fallback TikTok se blocco tipico
                if platform == "tiktok" and self._looks_like_tiktok_block(last_error):
                    return await self.tiktok_fallback.download_video(clean_url)
